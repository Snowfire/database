...
use Snowfire\Database\Query\Assignment;
use Snowfire\Database\Query\Columns;
use Snowfire\Database\Query\Conditions;
...
class Query
{
	...
	*/
	...
	{
		if (Helper::is_associative($values)) {
